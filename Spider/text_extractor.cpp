...
text_extractor::extract_and_count_words(std::string &html) {
...
void text_extractor::extract_text(
    GumboNode *node, std::unordered_map<std::string, int> &word_count) {
...
void text_extractor::process_text(
    const std::string &text, std::unordered_map<std::string, int> &word_count) {
